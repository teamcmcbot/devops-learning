    ...
    my-https-listener = {
      ...
      rules = {
        ...
        querystring-redirect-rule = {
          ...
          conditions = [{
            query_string = [{ # ✅ CORRECT: Must be a list of objects
              key   = "website"
              value = "aws-eks"
            }]
          }]
        } # End of querystring-redirect-rule Block
        ...
        hostheader-redirect-rule = {
          ...
          conditions = [{
            host_header = {
              values = [var.azure_dns_name]
            }
          }]
        } # End of hostheader-redirect-rule Block
      }   # End Rules Block

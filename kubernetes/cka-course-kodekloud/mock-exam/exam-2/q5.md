...
- **Certificate Signing Requests (CSR)**: Creating and approving certificate requests for cluster authentication
- **User Authentication**: Setting up user access using client certificates
- **RBAC - Roles**: Creating roles with specific permissions for resources
- **RBAC - RoleBindings**: Binding roles to users in specific namespaces
- **signerName**: Understanding kubernetes.io/kube-apiserver-client signer
- **Authorization Testing**: Using `kubectl auth can-i` to verify permissions
- **Base64 Encoding**: Understanding CSR request encoding requirements
...
- [Authorization Can-I](https://kubernetes.io/docs/reference/access-authn-authz/authorization/#checking-api-access)

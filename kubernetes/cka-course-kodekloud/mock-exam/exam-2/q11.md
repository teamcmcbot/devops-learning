...
- **Helm Releases**: Listing and managing deployed Helm charts
- **helm ls**: Listing releases across all namespaces
- **helm uninstall**: Removing deployed Helm releases
- **Image Inspection**: Extracting image information from deployments
- **jq Tool**: Parsing JSON output for data extraction
- **Security Scanning**: Identifying vulnerable container images
- **kubectl get with JSON output**: Using -o json for structured data retrieval
